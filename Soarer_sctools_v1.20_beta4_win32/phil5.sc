...
matrix
	...
	# 6
	muxstrobe 12	PAD_2		PAD_5		f17		f16	f15	backspace		EQUAL	EXTRA_PAD_PLUS	
	muxstrobe 13	PAD_ASTERIX	PAD_9		f18		PAD_4		PAD_8		PAD_SLASH		END			f14	
	# 7										^ orig PAD_1
	muxstrobe 14	PAD_MINUS	PAD_PLUS	UP				DELETE		PAD_7		NUM_LOCK		INSERT		MEDIA_MUTE	
	muxstrobe 15	BACKSPACE	PAD_PERIOD	f13		PAGE_DOWN	PAGE_UP		MEDIA_VOLUME_UP			HOME		MEDIA_VOLUME_DOWN	
	#										^ orig PAD_3
end
...
remapblock
	layer 1
		MEDIA_VOLUME_DOWN			SCROLL_LOCK 
		MEDIA_MUTE			PRINTSCREEN 
		MEDIA_VOLUME_UP				PAUSE 
		1					F1
		2					F2
		3					F3
		4					F4
		...
		MINUS				F11
		EQUAL				F12
		INSERT				MEDIA_PREV_TRACK
		HOME				MEDIA_PLAY_PAUSE
		PAGE_UP				MEDIA_NEXT_TRACK
endblock
